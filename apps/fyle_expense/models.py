...
class Expense(models.Model):
    ...
    category = models.CharField(max_length=64, null=True, blank=True, help_text='Fyle Expense Category')
    sub_category = models.CharField(max_length=64, null=True, blank=True, help_text='Fyle Expense Sub-Category')
    ...
    project = models.CharField(max_length=64, null=True, blank=True, help_text="Project")
